...
function zerif_register_widgets() {    
	...
	foreach ( $zerif_lite_sidebars as $zerif_lite_sidebar ):
		...
		if( $zerif_lite_sidebar == 'sidebar-ourfocus' ):
			...
			$zerif_lite_name = __('PRESTATIONS WIDGETS', 'zerif-lite');
		
		elseif( $zerif_lite_sidebar == 'sidebar-testimonials' ):
		
			$zerif_lite_name = __('CONCERTS WIDGETS', 'zerif-lite');
			
		elseif( $zerif_lite_sidebar == 'sidebar-ourteam' ):
		
			$zerif_lite_name = __('PHOTOS SLIDER WIDGETS', 'zerif-lite');
...
<div class="col-xs-8 col-sm-8 col-md-3 col-lg-3 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
