...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					echo '<div class="zerif-copyright-box"><a class="zerif-copyright" '.$attribut_new_tab.' rel="nofollow">La Clé des Chants </a>'.__('réalisé par','zerif-lite').'<a class="zerif-copyright" href="http://wildcodeschool.fr/"'.$attribut_new_tab.' rel="nofollow"> Wild Code School</a></div>';
